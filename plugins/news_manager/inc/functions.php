...
//modificada para quitar el readmore
 ...
 * @since 3.0
 */
//modificado para poner una imagen representativa
...
$imagepresentacion="/imgs_/usal.png";
foreach ($images as $img) {
    if ($img['src'] ){$imagepresentacion=$img['src'];break;}
}
...
<div style="
   ...
   max-height: 13em;
    overflow: hidden;">
<img class="img-rounded" alt="" src="'.$imagepresentacion.'" style="width: 10em;
    " />
</div>
...
/*
  $resultado='
  <div class="row">
  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="margin: auto;"><img class="img-rounded" alt="" src="'.$imagepresentacion.'" style="width: 100%; height: 200px;" /></div>
...
<div style="
   ...
   max-height: 200px;
    overflow: hidden;">
<img class="img-rounded" alt="" src="'.$imagepresentacion.'" style="width: 240px;
    " />
</div>
